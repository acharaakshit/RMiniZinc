...
The declaration associated with the assignment should also be provided along with the assignment string. Make sure that the declaration doesn't have a value.
