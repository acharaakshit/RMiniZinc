...
For now, this package can only support constraints which involve arithmetic operators only. The utility to use inbuild functions and loops like 'forall' and 'exists' will be provided soon.
