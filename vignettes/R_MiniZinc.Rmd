...
Now download the solver binaries from the binary bundles to be able to solve the models and achieve full functionality of the package.
...
If you have the source tar, then you can do `R CMD INSTALL --configure-args='--with-mzn=/path/to/libminizinc' rminizinc_0.0.0.99.tar.gz`
