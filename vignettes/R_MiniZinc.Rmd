...
print(solObj)
```
The data can also be provided as a list of values of parameters where the names of the list are the parameter names. The order of the values should be the same as the order of declaration of parameters in the model. For now, only integer, floats, bools and 1 dimensional integer arrays are supported.
