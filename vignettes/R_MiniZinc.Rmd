...
The domain of a variable can be modified using the function `modifyDomain`. The item number of the variable whose domain is to be changed needs to be supplied along with the values to be modified. Domains of type Set name and integer or float ranges can be set currently. 
