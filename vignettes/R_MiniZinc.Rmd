...
The examples of how to use these functions to solve optimization problems can be found in `mzn_examples` which are taken from [minizinc-examples](https://github.com/MiniZinc/minizinc-examples).
